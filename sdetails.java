...
public class sdetails extends JFrame implements ActionListener{
    ...
    public sdetails() {
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("sun/images/searchimage.png"));
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("sun/images/deleteimage.png"));
		...
		ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("sun/images/backimage.png"));
