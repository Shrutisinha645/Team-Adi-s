...
public class stats extends JFrame{
    ...
    public stats() {
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("sun/images/backimage.png"));
		...
		panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 204, 153), 2, true), "Return-Book-Details", TitledBorder.RIGHT, TitledBorder.TOP, null, new Color(0, 102, 51)));
